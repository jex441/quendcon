...
export default function Home() {
  ...
  return (
    <>
      ...
      <nav>
        <a className="nav-logo" href="#hero">QuendCon</a>
      ...
      <section id="hero">
        ...
        <div className="hero-meta">
          ...
          <span className="hero-venue">
            <a href="https://www.osnyc.com" target="_blank" rel="noopener">OS NYC</a>
            {" · "} New York, NY
          </span>
        </div>
      ...
      <section id="about">
        ...
        <h2 className="section-title">Where security&apos;s best minds gather</h2>
        <div className="about-body">
          ...
          <p>
            At its core is the DiceCTF Finals, where twelve of the world&apos;s best
            teams compete across a range of hardware and software hacking
          ...
          <p>
            ...
            Tolkien&apos;s lore — a nod to the brilliant, relentless minds who make
      ...
      <section id="program">
        ...
        <h2 className="section-title">Two days of competition and conversation</h2>
        <div className="program-grid">
          <div className="program-card hackathon">
            ...
            <p>
              ...
              more — each designed to surface the sharpest technical minds in the
              community.
            </p>
          </div>
      ...
      <section id="schedule">
        ...
        <div className={`schedule-day${activeDay === "day1" ? " active" : ""}`} id="day1">
          ...
          <div className="schedule-entry">
            ...
            <div>
              <span className="entry-title">Open Networking &amp; Sponsor Tables</span>
            </div>
          </div>
          <div className="schedule-entry">
          ...
          <div className="schedule-entry">
            <span className="entry-time">5:00 PM</span>
            <div>
              <span className="entry-title">Light Refreshments &amp; Networking</span>
              <div className="entry-tag tag-food">Food</div>
        ...
        <div className={`schedule-day${activeDay === "day2" ? " active" : ""}`} id="day2">
          ...
          <div className="schedule-entry">
            <span className="entry-time">9:45 AM</span>
            <div><span className="entry-title">Day 2 Kickoff</span></div>
          </div>
          <div className="schedule-entry">
            <span className="entry-time">10:00 AM</span>
            <div>
          ...
          <div className="schedule-entry">
            ...
            <div>
              <span className="entry-title">Hackathon Results &amp; Awards Ceremony</span>
          ...
          <div className="schedule-entry">
            <span className="entry-time">5:00 PM</span>
            <div>
              <span className="entry-title">Hackathon ends &amp; Closing Remarks</span>
              <div className="entry-tag tag-hackathon">CTF</div>
            </div>
          </div>
          <div className="schedule-entry">
      ...
      <section id="cta">
        <div className="cta-inner">
          ...
          <a href="mailto:chelsea@margin.re" className="btn btn-ghost">Contact us</a>
        </div>
      </section>

      <footer>
        <span className="footer-logo">QuendCon 2026</span>
        <span className="footer-copy">August 29–30 · OS NYC · New York, NY</span>
      </footer>
    </>
  );
}
